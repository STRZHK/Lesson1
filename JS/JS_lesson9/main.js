...
//     let div = document.createElement(`div`);
//     div.classList.add(`member`)
//     div.innerText = `Name: ${person.name}, Surname: ${person.surname},Age: ${person.age}`;
//     document.body.appendChild(div);
// }
...
for (const element of coursesArray) {
    ...
    titleH.innerText = `${element.title}`;
    titleH.style.fontSize = `30px`
    titleH.style.background = `blue`
    titleH.style.width = `300px`
    titleH.style.height = `50px`
    let monthDurationH = document.createElement(`h1`);
    monthDurationH.innerText = `${element.monthDuration}`;
    monthDurationH.style.fontSize = `20px`
    monthDurationH.style.background = `silver`
    monthDurationH.style.width = `100px`
    monthDurationH.style.height = `20px`

    let hourDurationH = document.createElement(`h1`);
    hourDurationH.innerText = `${element.hourDuration}`;
    hourDurationH.style.fontSize = `15px`
    hourDurationH.style.width = `90px`
    hourDurationH.style.height = `40px`

    document.body.appendChild(titleH);
    document.body.appendChild(monthDurationH);
    document.body.appendChild(hourDurationH);

    for (const module of element.modules) {
        let liH = document.createElement("li");
        liH.innerText = `${module}`
        document.body.appendChild(liH);
    }
